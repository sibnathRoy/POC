            ...
            <div className="row">
              <div className="col-lg-3 col-md-6">
                <Link className="navbar-brand pe-4" href="/">
                  <img src="/assets/imgs/template/logo-black.svg" alt="" />
                </Link>
                <p className="paragraph-base secondery-600 opacity-8 pt-4 pb-2">
                ...
                <p className="text-inline">
                  ...
                  <span className="secondery-600">+123 888 9999</span>
                </p>
                <p className="text-inline">
                  <svg
                    className="me-2"
              ...
              <div className="col-lg-3 col-md-6">
                ...
                <div className="pt-4">
                  <p className="paragraph-base secondery-600 opacity-8">
                ...
                <div className="box-social-profile pt-4">
                  <p className="paragraph-bold secondery-600 text-uppercase">
                    Social Profile
                  </p>
            ...
            <div className="container py-4">
              <div className="footer-bottom">
                <div className="row paragraph-base">
                  <div className="col">
                    <div className="small secondery-600">
                      Copyright © Vatech {new Date().getFullYear()} . Alright
                      Reserved.
                    </div>
                  </div>
                  <div className="col d-flex justify-content-end">
                    <p className="secondery-600">
                      Designed By{" "}
                      <Link
