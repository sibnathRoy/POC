          ...
          <div className="container">
            <div className="top-footer-logo">
              <div className="left-footer">
                <h3 className="sub-heading-ag-xl color-white">
                  Hire One Of The Best Consult Advisior
                </h3>
              </div>
              <div className="middle-footer">
                <Link href="/">
                  <img
                    src="/assets/imgs/template/logo-footer-2.svg"
                    alt="Vatech"
                  />
                </Link>
              </div>
              <div className="right-footer">
                ...
                <h3 className="sub-heading-ag-xl color-white-60">
                  990 988 9090
                </h3>
              </div>
            </div>
