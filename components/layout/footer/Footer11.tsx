          ...
          <div className="container">
            <div className="box-newsletter-footer">
              <div className="newsletter-left">
                <div className="mb-3">
                  <Link href="#">
                    <img src="/assets/imgs/template/logo-footer-3.svg" />
                  </Link>
                </div>
              ...
              <div className="newsletter-right">
                <h6 className="sub-heading-ag-xl-m color-white">
                ...
                <div className="box-social-profile pt-2">
                  <div className="list-socials">
                    <Link href="#" className="share fb">
                      ...
                      >
                        <path
                          d="M2.66426 18H5.83755V9.7875H8.49097L8.8917 6.5925H5.83755V4.545C5.83755 3.6225 6.08664 2.9925 7.36462 2.9925H9V0.12375C8.71841 0.0899999 7.75451 0 6.62816 0C4.26715 0 2.66426 1.49625 2.66426 4.23V6.5925H0V9.7875H2.66426V18Z"
                          fill="white"
                        />
                      </svg>
                    </Link>
                    <Link href="#" className="share tw">
                      ...
                      >
                        <path
                          d="M8.73508 6.35148L14.1991 0H12.9043L8.1599 5.5149L4.37056 0H0L5.73023 8.3395L0 15H1.29487L6.30508 9.17608L10.3069 15H14.6775L8.73477 6.35148H8.73508ZM6.96158 8.41297L6.38099 7.58255L1.76143 0.974755H3.75027L7.47831 6.30746L8.05891 7.13788L12.9049 14.0696H10.9161L6.96158 8.41329V8.41297Z"
                          fill="white"
                        />
                      </svg>
                    </Link>
                    ...
                    <div className="pt-4">
                      ...
                      <p className="text-inline">
                        <Link href="/mailto:support@realco.com">
                          ...
                          >
                            <path
                              d="M23.251 3.91016H2.86043C2.42664 3.91016 2.07617 4.25947 2.07617 4.69184V20.3256C2.07617 20.758 2.42664 21.1073 2.86043 21.1073H23.251C23.6848 21.1073 24.0353 20.758 24.0353 20.3256V4.69184C24.0353 4.25947 23.6848 3.91016 23.251 3.91016ZM22.2707 6.61675V19.3485H3.84075V6.61675L3.16433 6.09155L4.12749 4.85795L5.17643 5.6714H20.9375L21.9864 4.85795L22.9496 6.09155L22.2707 6.61675V6.61675ZM20.9375 5.66895L13.0557 11.7759L5.17398 5.66895L4.12504 4.85551L3.16187 6.08911L3.83829 6.61431L12.2102 13.1023C12.451 13.2887 12.7472 13.39 13.0521 13.39C13.3569 13.39 13.6531 13.2887 13.8939 13.1023L22.2707 6.61675L22.9472 6.09155L21.984 4.85795L20.9375 5.66895Z"
                              fill="white"
                            />
                          </svg>
                          <span className="color-white-70 paragraph-rubik-r">
