              ...
              <div className="top-footer-right">
                <div className="form-newsletter">
                  <form action="#">
                    ...
                    />
                    <input type="button" className="btn btn-newsletter" />
                  </form>
                </div>
              </div>
            </div>
            <div className="row">
              <div className="col-lg-3 col-md-6 mb-4">
                <Link className="navbar-brand pe-4" href="/">
                  <img src="/assets/imgs/template/logo-footer-5.svg" alt="" />
                </Link>
                ...
                <div className="box-social-profile pt-2">
                  <div className="list-socials">
                    <Link href="#" className="share">
                      ...
                      >
                        <path
                          d="M7.62891 8.14062H5.57812V14.2656H2.84375V8.14062H0.601562V5.625H2.84375V3.68359C2.84375 1.49609 4.15625 0.265625 6.15234 0.265625C7.10938 0.265625 8.12109 0.457031 8.12109 0.457031V2.61719H7C5.90625 2.61719 5.57812 3.27344 5.57812 3.98438V5.625H8.01172L7.62891 8.14062Z"
                          fill="currentColor"
                        />
                      </svg>
                    </Link>
                    <Link href="#" className="share">
                      ...
                      >
                        <path
                          d="M10.0596 6.86085L15.8879 0.0859375H14.5068L9.44607 5.96849L5.40411 0.0859375H0.742188L6.85442 8.98141L0.742188 16.0859H2.12338L7.4676 9.87376L11.7362 16.0859H16.3981L10.0593 6.86085H10.0596ZM8.16787 9.05978L7.54857 8.17399L2.62104 1.12568H4.74248L8.71905 6.81389L9.33834 7.69968L14.5074 15.0935H12.386L8.16787 9.06012V9.05978Z"
                          fill="currentColor"
                        />
                      </svg>
                    </Link>
                    <Link href="#" className="share">
                      ...
                      >
                        <path
                          d="M11.375 0.140625C11.8398 0.140625 12.25 0.550781 12.25 1.04297V11.5156C12.25 12.0078 11.8398 12.3906 11.375 12.3906H0.847656C0.382812 12.3906 0 12.0078 0 11.5156V1.04297C0 0.550781 0.382812 0.140625 0.847656 0.140625H11.375ZM3.69141 10.6406V4.81641H1.88672V10.6406H3.69141ZM2.78906 3.99609C3.36328 3.99609 3.82812 3.53125 3.82812 2.95703C3.82812 2.38281 3.36328 1.89062 2.78906 1.89062C2.1875 1.89062 1.72266 2.38281 1.72266 2.95703C1.72266 3.53125 2.1875 3.99609 2.78906 3.99609ZM10.5 10.6406V7.44141C10.5 5.88281 10.1445 4.65234 8.3125 4.65234C7.4375 4.65234 6.83594 5.14453 6.58984 5.60938H6.5625V4.81641H4.83984V10.6406H6.64453V7.76953C6.64453 7.00391 6.78125 6.26562 7.73828 6.26562C8.66797 6.26562 8.66797 7.14062 8.66797 7.79688V10.6406H10.5Z"
                          fill="currentColor"
                        />
                      </svg>
                    </Link>
              ...
              <div className="col-lg-2 col-md-6 mb-4">
                ...
                <div className="d-flex flex-column align-items-start">
                  <Link
                    className="hover-effect paragraph-base grey-100 pt-1"
                    href="#"
                  >
                    {" "}
                    About Us{" "}
                  ...
                  <Link
                    className="hover-effect paragraph-base grey-100 pt-3"
                    href="#"
                  >
                    {" "}
                    Our Team{" "}
                ...
                <div className="pt-0">
                  <p className="text-inline">
                    <Link href="/mailto:dolores.chambers@example.com">
                      ...
                      >
                        <path
                          d="M12.6875 1.5C13.3984 1.5 14 2.10156 14 2.8125C14 3.25 13.7812 3.63281 13.4531 3.87891L7.51953 8.33594C7.19141 8.58203 6.78125 8.58203 6.45312 8.33594L0.519531 3.87891C0.191406 3.63281 0 3.25 0 2.8125C0 2.10156 0.574219 1.5 1.3125 1.5H12.6875ZM5.93359 9.04688C6.5625 9.51172 7.41016 9.51172 8.03906 9.04688L14 4.5625V10.25C14 11.2344 13.207 12 12.25 12H1.75C0.765625 12 0 11.2344 0 10.25V4.5625L5.93359 9.04688Z"
                          fill="currentColor"
                        />
                      </svg>
                      <span className="color-white-70">
                  ...
                  <ul className="recent-news-list">
                    <li>
                      <div className="news-image">
                        <Link href="#">
                          <img
                            src="/assets/imgs/pages/home13/news2.png"
                            alt="Vatech"
                          />
                        </Link>
                      </div>
                      <div className="news-info">
                        <div className="news-postdate">
                          ...
                          <span className="paragraph-rubik-r color-white-70">
                            17 oct 23
                          </span>
                        </div>
                        <Link href="#" className="paragraph-rubik-r news-link">
                    ...
                    <li>
                      <div className="news-image">
                        <Link href="#">
                          <img
                            src="/assets/imgs/pages/home13/news3.png"
                            alt="Vatech"
                          />
                        </Link>
                      </div>
              ...
              <div className="footer-bottom">
                <div className="row paragraph-base">
                  <div className="col-sm-6 col-12 text-center text-md-start">
                    <div className="paragraph-rubik-r color-white-70">
