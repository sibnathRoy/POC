          ...
          <div className="container">
            <div className="row">
              <div className="col-lg-4 col-md-6">
                <h3 className="heading-24-fitree color-white mb-20">
                  About Us
                </h3>
                <p className="paragraph-base color-white mb-40">
              ...
              <div className="col-lg-4 col-md-6">
                ...
                <div className="box-social-profile pt-4">
                  <p className="paragraph-ag-semibold text-uppercase color-white">
                    Social Profile
                  </p>
            ...
            <div className="container pt-0 py-4">
              <div className="footer-bottom">
                <div className="row paragraph-base">
                  <div className="col">
                    <div className="paragraph-rubik-m dark-950">
                      Copyright © Vatech {new Date().getFullYear()} . Alright
                      Reserved.
                    </div>
                  </div>
                  <div className="col d-flex justify-content-end">
                    <Link href="#" className="paragraph-rubik-m  dark-950">
